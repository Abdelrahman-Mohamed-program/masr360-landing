...
const FORM_STEPS = [
  {
    ...
    type: 'stars',
    link: 'https://www.m360travel.com/discover',
    icon: (
  ...
  },
  {
    ...
    type: 'stars',
    link: 'https://www.m360travel.com/places',
    icon: (
  ...
  },
  {
    ...
    type: 'stars',
    link: 'https://www.m360travel.com/nights',
    icon: (
  ...
  },
  {
    ...
    type: 'stars',
    link: 'https://www.m360travel.com/marketplace',
    icon: (
...
export default function FormSection() {
  ...
  const copyLink = () => {
    navigator.clipboard.writeText('https://m360travel.com')
    setCopySuccess(true)
    ...
    <div className="space-y-5 py-4">
      ...
      <div className="flex gap-3 pt-2">
        ...
        <motion.button
          ...
          className="btn-physical flex-1 px-6 py-3.5 rounded-xl bg-m360-gold text-m360-bg font-heading font-bold text-sm cursor-pointer disabled:opacity-50"
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
        >
